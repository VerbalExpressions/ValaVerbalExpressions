...
namespace Verbex { 
	...
	Test(name="Test for range() edge cases")
	public class RangeTest : Valadate.Framework.TestCase {
...
// [Test]
		...
		public void Range_WhenOddNumberOfItemsInArray_ShouldAppendLastElementWithOrClause()
		{
			//Arrange
			var verbEx = VerbalExpressions.DefaultExpression;
			string tex= "abcd7sdadqascdaswde";
...
// [Test]
		...
		public void Range_WhenArrayParameterHasValuesInReverseOrder_ReturnsCorrectResultForCorrectOrder()
		{
			...
			//Act
			booisMatch = verbEx.IsMatch(lookupString);
